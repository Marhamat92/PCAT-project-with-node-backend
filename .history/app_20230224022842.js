...
//! Connect to MongoDB
mongoose.connect('mongodb+srv://DB_HOST:DB_PASSWORD@cluster0.5tmexrn.mongodb.net/pcat-db?retryWrites=true&w=majority', { useNewUrlParser: true }, { useUnifiedTopology: true }, { useFindAndModify: false }, { strctQuery: false })
