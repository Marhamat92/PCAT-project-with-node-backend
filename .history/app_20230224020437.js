...
//! Connect to MongoDB
mongoose.connect('mongodb+srv://marhamatbaghirov:bgskKGsH1Rlnt8su@cluster0.5tmexrn.mongodb.net/pcat-db?retryWrites=true&w=majority', { useNewUrlParser: true }, { useUnifiedTopology: true }, { useFindAndModify: false }, { strctQuery: false })
